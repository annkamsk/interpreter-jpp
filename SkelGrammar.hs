...
transTopDef x = case x of
  FnDef typeorvoid ident args block -> failure x
transArg :: Arg -> Result
...
transTypeOrVoid :: TypeOrVoid -> Result
transTypeOrVoid x = case x of
  TVVoid -> failure x
  TVType type_ -> failure x
transExpr :: Expr -> Result
transExpr x = case x of
  ArraySet expr1 expr2 expr3 -> failure x
  ArrayPush expr1 expr2 -> failure x
  ArrayRem expr1 expr2 -> failure x
  ArrayGet expr1 expr2 -> failure x
  ArrayLen expr -> failure x
  EVar ident -> failure x
  ELitInt integer -> failure x
  ELitTrue -> failure x
  ELitFalse -> failure x
  EApp ident exprorrefs -> failure x
...
transExprOrRef x = case x of
  ExprRefE expr -> failure x
  ExprRefR ident -> failure x
